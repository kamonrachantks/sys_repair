...
if ($mode == "chk") {
    ...
    if (!duIdExists($du_id, $optionsForDatalist)) {
        $duIdNotFound = true;
        $response = array('error' => false, 'message' => 'รหัสครุภณฑ์ไม่ถูกต้อง');
                        ...
                        <div class="col-md-6 mx-auto">
                            ...
                            <form name="form1" method="post" action="?Action=chk" id="form1">
                                ...
                                <div class="mb-3">
                                    <div style="padding-top: 30px;">
                                        <label>เวลา</label>
                                        <input type="text  " class="form-control appointment_time" placeholder='<?php echo date("H:i:s")?>' name="m_time" required="true" disabled>
                                    </div>
                                </div>
