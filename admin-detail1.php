...
try {
    ...
    $sqlAppointmentHistory = "SELECT m.m_id, m.p_id, m.m_date_S, m.m_time, m.m_status, d.du_name, p.p_name, p.p_tel, m.m_date_C, s.s_price, s.s_servicename
        FROM tb_du_maint m
                        ...
                        <div class="table-content table-responsive cart-table-content m-t-30">
                            ...
                            <table class="table table-bordered">
                                <?php while ($row = $stmtAppointmentHistory->fetch(PDO::FETCH_ASSOC)) { ?>
                                    ...
                                    <tr>
                                        <th>อาการซ่อม</th>
                                        <td><?php echo $row['s_servicename']; ?></td>
                                    </tr>
